(function(global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(
      ...
      require("react"),
      require("react-dom"),
      require("react-async-script-loader"),
      require("prop-types")
    );
  } else {
    var mod = {
  ...
  var _reactAsyncScriptLoader2 = _interopRequireDefault(
    _reactAsyncScriptLoader
  );
  ...
  var PaypalButton = (function(_React$Component) {
    ...
    function PaypalButton(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (PaypalButton.__proto__ || Object.getPrototypeOf(PaypalButton)).call(
          this,
          props
        )
      );
          ...
          var onAuthorize = function onAuthorize(data, actions) {
            return actions.payment.execute().then(function(payment_data) {
              ...
              payment.transactionID =
                payment_data.transactions[0].related_resources[0].sale.id;
